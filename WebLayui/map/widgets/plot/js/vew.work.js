/* 2017-12-4 15:37:20 | 修改 木遥（QQ：346819890） */
var thisWidget;
    ...
    initEvent: function () {
        ...
        $("#btn_plot_savefile").click(function () {
            ...
            if(data == null||data==""){
            	...
            	haoutil.file.downloadFile("我的标注.json", data);
            }
        });
...
var plotlist = {
    ...
    bindSelList: function () {
        ...
        $.getJSON("config/plotlist.json", function (plotlist) {
            ...
            if (defval) {
                $this.showPlotList(plotlist[defval]);
    ...
    startPlot: function (idx, li) {
        ...
        var defval = haoutil.system.clone(plotEdit.defval[item.type] || {});
        if (item.style) {
            ...
            case "text":
                ...
                fun = function (parname, attrName, attrVal, edit) {
                    $('#' + parname + attrName).on("input propertychange", function (e) {
                        ...
                        $this.updateAttr(parname, attrName, attrVal);
                    });
                };
                break;
            case "textarea":
            ...
            case "radio":
                ...
                fun = function (parname, attrName, attrVal, edit) {
                    $('input:radio[name="' + parname + attrName + '"]').change(function () {
                        ...
                        $this.changeViewByAttr(parname, edit.impact, attrVal);
                    });
                    $this.changeViewByAttr(parname, edit.impact, attrVal);
                };
                break;
                ...
                fun = function (parname, attrName, attrVal, edit) {
                    $('#' + parname + attrName).minicolors({
                        ...
                        change: function (hex, opacity) {
                            $this.updateAttr(parname, attrName, hex);
                        }
                    });
                };
                break;

...
L.widget.bindClass(L.widget.BaseWidget.extend({
    ...
    create: function (viewopt) {
        var item = {
            ...
            "opacity": 0.7,
            "type": "arcgis_dynamic",
            "url": "http://10.32.49.31:6080/arcgis/rest/services/GDCJJC/MapServer",
            "crs": "4326",
            "popup": "all",
            "visible": true
        };
    ...
    addLayer: function (mpts) {
        var dd = L.esri.dynamicMapLayer({
            ...
            opacity: 0.8,
            crs:'4326',
            url: "http://10.32.49.27:6080/arcgis/rest/services/GDCJJC/MapServer"
        }).addTo(map);
        map.flyTo([31.85, 120.20], 11);
    ...
    //        //radius: 20,
    //        //blur: 10,
    //        url: "http://10.32.49.27:6080/arcgis/rest/services/GDCJJC/MapServer/0"
    //    }).addTo(map);

layui.define(["element", "jquery"], function (exports) {
    ...
    layuimini = new function () {
        ...
        this.init = function (url) {
            ...
            $.getJSON(url, function (data, status) {
                if (data == null) {
                    ...
                    layuimini.initTab();
                    layuimini.initHeadMenu(data.headmenuInfo)
                }
            }).fail(function () {
        ...
        * @param data
        */
        this.initHeadMenu = function (data) {
            var headerMenuHtml = '',
            ...
            $.each(data, function (key, val) {
                if (val.href == "") {
                    headerMenuHtml += '<li class="layui-nav-item ' + '"> <a href="javascript:;" ><i class="layui-icon"></i><span>' + val.title + '</span></a> </li>\n';
                } else {

                    headerMenuHtml += '<li class="layui-nav-item ' + '"> <a href="javascript:;" data-iframe-tab="' + val.href + '" data-title="' + val.title + '" data-icon="' + val.icon + '"><i class="layui-icon"></i><span>' + val.title + '</span></a> </li>\n';

                }
            });
            
            $('.layui-layout-right').append(headerMenuHtml);
            element.init();
        };
        /**
         * 初始化菜单栏
